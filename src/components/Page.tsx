    ...
    return (
        <>
            ...
            <PageHeader title={props.title}
                        avatar={{icon: props.icon, size: "large", shape: "circle"}}
                        extra={
                            [
                                <Button key={"mrMiaggi"} type={"ghost"} ghost={false} icon={<SettingFilled/>}
                                        size={"large"}
                                        shape={"round"}/>,
                                <Popover key={"bugg"} trigger="click" content={content} placement={"left"}>
                                    <Button key={"Karate"} type={"ghost"} ghost={false} icon={<QuestionCircleOutlined/>}
                                            size={"large"}
                                            shape={"round"}/>
                                </Popover>
                            ]
